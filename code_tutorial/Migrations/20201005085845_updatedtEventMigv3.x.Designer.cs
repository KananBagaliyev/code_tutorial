...
namespace code_tutorial.Migrations
{
    ...
    [Migration("20201005085845_updatedtEventMigv3.x")]
    partial class updatedtEventMigv3x
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("code_tutorial.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.ChatUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.RepliedComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.SavedSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.Subscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("code_tutorial.Models.ChatUser", b =>
                {
                    b.HasOne("code_tutorial.Models.Chat", "Chat")
                        .WithMany("ChatUsers")
            ...
            modelBuilder.Entity("code_tutorial.Models.Comment", b =>
                {
                    b.HasOne("code_tutorial.Models.Article", "Article")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("code_tutorial.Models.RepliedComment", b =>
                {
                    b.HasOne("code_tutorial.Models.Article")
                        .WithMany("RepliedComments")
                        .HasForeignKey("ArticleId");

                    b.HasOne("code_tutorial.Models.Comment", "Comment")
                        .WithMany("RepliedComments")
